...
-- Create function to calculate daily algorithm performance
...
-- Schedule the performance calculation to run daily at 5:00 PM ET (after market close)
SELECT cron.schedule(
    'daily-algorithm-performance',
    '0 21 * * 1-5',  -- 9 PM UTC = 5 PM ET on weekdays
    $$SELECT calculate_daily_algorithm_performance();$$
);