-- Update the morning market analysis cron job to run at 7:30 AM ET
SELECT cron.unschedule('morning-market-analysis');

SELECT cron.schedule(
  'morning-market-analysis',
  '30 7 * * 1-5', -- Run at 7:30 AM Monday-Friday (before market open)
  $$
  select
    net.http_post(
